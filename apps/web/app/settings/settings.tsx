          ...
          <div className="space-y-8">
                ...
                >
                  <div className="space-y-4">
                    <userForm.AppField name="username">
                      {(field) => <field.Input className="max-w-2xs" label="Username" placeholder={currentUsername} />}
                    </userForm.AppField>
                          ...
                          {(field) => {
                            ...
                            return (
                              <div className="space-y-2">
                                ...
                                {password && (
                                  <p
                                    className={classNames("text-xs", isStrong ? "text-emerald-400" : "text-amber-400")}
                                  >
            ...
            <settingsForm.AppForm>
              <settingsForm.Form className="space-y-4">
                ...
                <div className="mt-4 flex items-center gap-4">
                  <settingsForm.SubmitButton icon={<Save className="h-4 w-4" />}>
                    Save settings
